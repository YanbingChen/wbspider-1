            ...
            try {
                ...
                if(response.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                    ...
                    for (int j = 0; j < posts.size(); j++) {
                        ...
                        // 获取帖子文本内容
                        String text = "";
                        if (mblog.get("isLongText").toString().equals("false")) {
